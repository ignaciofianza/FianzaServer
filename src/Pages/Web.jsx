        ...
        <div className="col-md-8">
          <div className="bg-dark text-light p-5 rounded shadow-lg">
            ...
            <p className="lead text-muted">
              Guía paso a paso para crear y hostear una web utilizando Nginx en un servidor Ubuntu.
            </p>

            {/* Coming Soon */}
            <div className="mt-4">
              <h3 className="text-warning">⏳ ¡Próximamente!</h3>
              <p>Esta guía estará disponible pronto. Mientras tanto, prepárate para aprender cómo configurar Nginx y Ubuntu Server.</p>
            </div>
